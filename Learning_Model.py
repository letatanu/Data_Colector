...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=10, kernel_size=2, stride=1)
        self.conv2 = nn.Conv2d(10, 30, 2, 1)
        self.dropout1 = nn.Dropout2d(0.25)
        self.dropout2 = nn.Dropout2d(0.5)
        self.fc1 = nn.Linear(46560, 30)
...
def main():
    ...
    db_handler = DB_Handler(data_dir="./Data", scene_dir="test1")
    trainDB_loader = DB_Loader(root_dir="./Data/training/test1", db=db_handler.read_db(db_set="training"))

    train_loader = torch.utils.data.DataLoader(trainDB_loader,
                                               batch_size=args.batch_size, shuffle=True, **kwargs)

    testDB_loader = DB_Loader(root_dir="./Data/testing/test1", db=db_handler.read_db(db_set="testing"))
